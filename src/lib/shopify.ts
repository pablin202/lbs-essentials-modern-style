...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'veen7x-cg.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = 'ba809a49be26f7b3a2f848858c7448d4';
...
export async function fetchCollectionByHandle(handle: string, first = 8): Promise<ShopifyProduct[]> {
